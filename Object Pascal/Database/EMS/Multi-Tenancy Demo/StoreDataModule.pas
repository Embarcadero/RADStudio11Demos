...
begin
  ...
  try
    ...
    AResponse.Body.SetStream(LStream, ctAPPLICATION_VND_EMBARCADERO_FIREDAC_JSON, True);
  except
    LStream.Free;
    raise;
  end;
...
var
  LStream: TStream;
begin
  if not SameText(ARequest.Body.ContentType, ctAPPLICATION_VND_EMBARCADERO_FIREDAC_JSON) then
